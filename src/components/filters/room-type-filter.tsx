...
export default function RoomTypeFilter({
  ...
  const { roomCategories, loading: categoryLoading } = useRoomCategoriesQuery({
    limit: 999,
    language: locale,
  });
    ...
    >
      {enableRoomCategory ? (
        <div className="w-full">
          <Label>Filter By Room Category</Label>
          <Select
